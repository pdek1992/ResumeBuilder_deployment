...
export function CorporateMinimalTemplate({ resume, template, isPrintMode }: ResumePreviewProps) {
  ...
  return (
    <div 
      ...
      data-template-layout="corporate-minimal"
    >
      <div className="px-8 py-8 md:px-12 border-b border-slate-100 flex justify-between items-end mb-8">
        <div>
