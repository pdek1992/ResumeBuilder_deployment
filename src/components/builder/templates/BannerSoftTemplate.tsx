...
export function BannerSoftTemplate({ resume, template, isPrintMode }: ResumePreviewProps) {
  ...
  return (
    <div 
      ...
      data-template-layout="banner-soft"
    >
      <div className="p-10 text-center" style={{ backgroundColor: `${accent}15` }}>
        ...
        <p className="mt-3 text-[14px] font-bold uppercase tracking-[0.35em]" style={{ color: accent }}>
