...
export function HybridProTemplate({ resume, template, isPrintMode }: ResumePreviewProps) {
  ...
  return (
    <div 
      ...
      data-template-layout="hybrid-pro"
    >
      <div className="px-8 py-10 md:px-12 mb-8" style={{ backgroundColor: `${accent}04` }}>
