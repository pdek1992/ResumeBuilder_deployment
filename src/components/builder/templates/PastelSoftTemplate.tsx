...
function PreviewHeading({ children, accent }: { children: React.ReactNode; accent: string }) {
  return (
    <div className="mb-4">
      <span className="inline-flex rounded-full px-3 py-1 text-[10px] font-black uppercase tracking-[0.22em]" style={{ backgroundColor: `${accent}12`, color: accent, WebkitPrintColorAdjust: "exact" }}>
        {children}
      </span>
    </div>
  );
...
export function PastelSoftTemplate({ resume, template, isPrintMode }: ResumePreviewProps) {
  ...
  return (
    <div 
      ...
      data-template-layout="pastel-soft"
    >
      <div 
        className="px-8 py-10 md:px-12 mb-8"
        style={{ backgroundColor: `${accent}10`, color: "inherit" }}
      >
          ...
          <div>
            ...
            <div className="mt-4 space-y-5">
              {resume.experience.map((item) => (
                <div key={item.id} className="relative break-inside-avoid border-b border-dotted pb-5" style={{ borderColor: `${accent}30` }}>
          ...
          <div>
            ...
            <div className="mt-4 space-y-5">
              {resume.education.map(item => (
                <div key={item.id} className="border-b border-dotted pb-5" style={{ borderColor: `${accent}30` }}>
