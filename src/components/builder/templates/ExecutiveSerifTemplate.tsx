...
export function ExecutiveSerifTemplate({ resume, template, isPrintMode }: ResumePreviewProps) {
  ...
  return (
    <div 
      ...
      data-template-layout="executive-serif"
    >
      <div 
        className="px-8 py-10 md:px-12 border-b-[3px] mb-8" 
        style={{ borderColor: accent, backgroundColor: `${accent}10` }}
      >
        <h1 className="font-serif text-[40px] font-black tracking-tight text-slate-900">{fullName}</h1>
        <p className="mt-2 font-serif text-[13px] font-bold uppercase tracking-[0.2em]" style={{ color: accent }}>
