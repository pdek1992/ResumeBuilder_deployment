...
export function AcademicClassicTemplate({ resume, template, isPrintMode }: ResumePreviewProps) {
  ...
  return (
    <div 
      ...
      data-template-layout="academic-classic"
    >
      <div className="p-10 text-center bg-transparent">
        <h1 className="text-[36px] font-serif font-black tracking-tight text-slate-950">{fullName}</h1>
        <p className="mt-3 text-[13px] font-serif font-bold uppercase tracking-widest" style={{ color: accent }}>
